...
public class ModRegisters {
	...
	public static final DeferredRegister<TileEntityType<?>> TILE_REGISTER = DeferredRegister.create(ForgeRegistries.TILE_ENTITIES, UPMAPI.MOD_ID);
	public static final DeferredRegister<Block> BLOCK_REGISTER = DeferredRegister.create(ForgeRegistries.BLOCKS, UPMAPI.MOD_ID);
	public static final DeferredRegister<Item> ITEM_REGISTER = DeferredRegister.create(ForgeRegistries.ITEMS, UPMAPI.MOD_ID);
	...
	public static final DeferredRegister<NetworkMemberResolver<?>> RESOLVER_REGISTER = DeferredRegister.create((Class) NetworkMemberResolver.class, UPMAPI.MOD_ID);
	...
	static {
		UPMAPI.RESOLVER_REGISTRY = ModRegisters.RESOLVER_REGISTER.makeRegistry("network_member", RegistryBuilder::new);
	}
